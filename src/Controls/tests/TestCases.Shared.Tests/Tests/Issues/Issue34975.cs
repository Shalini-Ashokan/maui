...
public class Issue34975 : _IssuesUITest
{
	...
	public void ShellTitleViewWithXNameShouldNotLeakMemory()
	{
		...
		// so allow 30 s total for the status label to reflect the final result.
		App.WaitForTextToBePresentInElement("StatusLabel", "Still alive:", timeout: TimeSpan.FromSeconds(30));
