...
[Issue(IssueTracker.Github, 00000, "CollectionView ScrollTo does not work with horizontal layout", PlatformAffected.iOS | PlatformAffected.macOS)]
public class Issue00000 : ContentPage
{
